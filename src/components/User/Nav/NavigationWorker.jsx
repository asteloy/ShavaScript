                ...
                <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <a data-page="У окна" className={`nav-link ${page === 'У окна' ? 'active' : ''}`} href="/"
                                onClick={repage}>У окна</a>
                        </li>
                        <li className="nav-item">
                            <a data-page="Страница смены" className={`nav-link ${page === 'Страница смены' ? 'active' : ''}`}
                                onClick={repage}>Страница смены</a>
                        </li>
                        <li className="nav-item">
                            <a data-page="Страница заказов" className={`nav-link ${page === 'Страница заказов' ? 'active' : ''}`}
                                onClick={repage}>Страница заказов</a>
                        </li>
                    </ul>
                    <ul className="navbar-nav d-flex">
                        <li className="nav-item">
                            <a data-page="Выйти" className={`nav-link${page === 'Главная' ? 'active' : ''}`} onClick={logOut}><i
